...
<div id="inscriptionShow" class="h-96 bg-indigo-80 justify-center items-center hidden z-50 backdrop-blur fixed inset-0">
    <div class="lg:w-2/5 md:w-1/2 w-2/3">
        <form class="bg-white p-8 rounded-lg shadow-lg min-w-full">
            ...
            <button type="submit" class="w-full mt-6 bg-indigo-600 rounded-lg px-4 py-2 text-lg text-white tracking-wide font-semibold font-sans" id="btn_close_pop">Enregistres</button>
