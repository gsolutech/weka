...
<div id="inscriptionShow" class="screen-minus-20 bg-indigo-80 justify-center items-center hidden backdrop-blur fixed w-11/12">
    <div class="w-11/12 sm:w-2/3 md:w-1/2 lg:w-2/5 mx-auto">
        <form action="" method="POST" class="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg w-full">
            ...
            <input type="submit" name="check_inscri" class="w-full mt-4 sm:mt-6 bg-indigo-600 rounded-lg px-4 py-2 text-lg text-white tracking-wide font-semibold font-sans" value="Enregistres">
            <button type="button"  class="w-full mt-4 sm:mt-6 mb-3 bg-indigo-100 rounded-lg px-4 py-2 text-lg text-gray-800 tracking-wide font-semibold font-sans" onclick="ShowConnexionPage_inscri_visible();">Se Connecter</button>
        </form>
    </div>
</div>
